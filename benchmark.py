...
if __name__ == '__main__':
    ...
    for current_step in range(args.phase_1_initial_step,args.phase_1_steps):
        ...
        if (current_step+1)%(1e2) == 0:
            ...
            try:
               print(np.array(np.load(f'metrics/{args.ID}/train_p2p_acc.npy'))[-int(1e2)::].mean(axis=0))
            except:
               print(None)
            try:
               print(np.array(np.load(f'metrics/{args.ID}/train_s2s_acc.npy'))[-int(1e2)::].mean(axis=0))
            except:
               print(None)

            print(np.array(np.load(f'metrics/{args.ID}/train_s2p_acc.npy'))[-int(1e2)::].mean(axis=0))
            print(np.array(np.load(f'metrics/{args.ID}/train_p2s_acc.npy'))[-int(1e2)::].mean(axis=0))
        ...
        if (current_step+1)%(args.phase_1_eval_interval) == 0:
            ...
            eval_s2p_acc.append([a/len(no_sample_dataset) for a in all_s2p_acc])
            eval_p2s_acc.append([a/len(no_sample_dataset) for a in all_p2s_acc])
    ...
    for current_step in range(args.phase_2_steps):
        ...
        if (current_step+1)%(1e2) == 0:
            ...
            print(np.array(np.load(f'metrics/{args.ID}/train_o2p_acc.npy'))[-int(1e2)::].mean(axis=0))
            print(np.array(np.load(f'metrics/{args.ID}/train_o2s_acc.npy'))[-int(1e2)::].mean(axis=0))
